...
exports.OperateMenus = OperateMenus;
exports.HeaderSettingsDropDown = HeaderSettingsDropDown;
...
var _httpFetch = _interopRequireDefault(require('share/httpFetch'));

var _table = _interopRequireDefault(require('../table'));

var _config = _interopRequireDefault(require('config'));

var _setting = _interopRequireDefault(require('./images/setting'));
...
function OperateMenus(props) {
  ...
  var overlay = /*#__PURE__*/ _react.default.createElement(
    _antd.Menu,
    {
...
function HeaderSettingsDropDown(props) {
  ...
  var selectedCol = (0, _react.useMemo)(
    function () {
      return tableColumns
        .filter(function (col) {
          return col.title;
  ...
  var _useSelections = (0, _ahooks.useSelections)(allCols, selectedCol),
  ...
  var settingIconRef = (0, _react.useRef)(); // 请求数据
  ...
  var onSave = function onSave(data) {
    ...
    _httpFetch.default
      .post(
        ''.concat(_config.default.baseUrl, '/api/user/component/setting'),
        params,
      )
      .then(function (res) {
  ...
  var renderTreeNode = function renderTreeNode(item) {
    return /*#__PURE__*/ _react.default.createElement(
      ...
      /*#__PURE__*/ _react.default.createElement(
        ...
        item.fixed === 'left'
          ? /*#__PURE__*/ _react.default.createElement(
              _icons.VerticalAlignMiddleOutlined,
              {
                title: '\u53D6\u6D88\u56FA\u5B9A',
                onClick: function onClick() {
          ...
          : /*#__PURE__*/ _react.default.createElement(
              _icons.VerticalAlignTopOutlined,
              {
                title: '\u5DE6\u56FA\u5B9A',
                onClick: function onClick() {
        ...
        item.fixed === 'right'
          ...
          : /*#__PURE__*/ _react.default.createElement(
              _icons.VerticalAlignBottomOutlined,
              {
                title: '\u53F3\u56FA\u5B9A',
                onClick: function onClick() {
...
var CustomTable = /*#__PURE__*/ (function (_Component) {
  ...
  function CustomTable(_props) {
            ...
            .get(
              ''
                .concat(
                  ...
                  '/api/user/component/setting/list?key=',
                )
        ...
        tableColumns = [
          {
            ...
            render: function render(value, record, index) {
              return /*#__PURE__*/ _react.default.createElement(OperateMenus, {
    ...
    _this.getList = function (url) {
      ...
      _httpFetch.default[methodType || 'get'](
        urlTemp,
        requestBody,
        null,
        null,
