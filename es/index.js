...
// 统一导出
export { default as LocaleProvider } from './components/locale-lan-provider'; // 基础
...
export { default as NewSearchArea } from './components/basic/new-search-area'; // 其他
...
export { default as BasicInfo } from './components/other/basic-info'; // 表单
...
export { default as ListerSelector } from './components/form/lov/list-selector'; // 业务组件
...
export { default as DocumentSubmitBtn } from './components/business-components/document-submit-btn'; // 附件
